...
def colocarFichasJugador(i,j,casilla):
    ...
    for k in range(len(fichas)):
        ficha = Button(frameFichas,width=3,height=1,bg="#fff1c7",text=fichas[k],font=fichasFont)
        ficha.grid(row=0, column=k) #Coloca las fichas del jugador en la interfaz
